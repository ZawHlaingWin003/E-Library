...
@section('content')
<div class="container">
    <a href="{{ route('admin.authors.create') }}" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Add New Author</a>
    <div class="table-responsive">
        ...
        <table class="table border no-wrap">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ ++$i }}</td>
                    <td class="author-img"><img src="{{ $author->profile }}" alt="" class="img-fluid"></td>
                    ...
                    <td class="txt-ofo">
                        ...
                        <a href="{{ route('admin.authors.edit', $author->id) }}" class="btn btn-sm btn-success">Edit <i class="fa fa-user-pen"></i></a>
