...
<div class="container">
    ...
    <a href="{{ route('admin-users.export') }}" class="btn btn-dark mb-3 float-end"><i class="fa fa-file-export"></i> Export To Excel</a>
    <a href="{{ route('admin-users.upload') }}" class="btn btn-dark mb-3">Import Excel Data <i class="fa fa-file-import"></i></a>
